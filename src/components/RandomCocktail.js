          ...
          <div className="container">
            <div className="columns is-centred">
              <div className="column is-two-thirds-desktop">
                <h1 className="title is-1">Welcome to Online Bar</h1>
                <h2 className="subtitle">Click the cocktail shaker Botton for a random cocktail drinks</h2>
              </div>
              <div className="column is-one-third has-text-centred">
                <button className="button random-cocktail-button" onClick={this.handleRandomCocktail}>Shake me to cocktail name</button>

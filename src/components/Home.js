        ...
        <div className="container">
          <section className="section" ref={elem => this.searchResultsSection = elem}>
            <form onSubmit={this.handleSubmit}>
              ...
              <h3>Happy to serve you , Am <strong>Navaneethan </strong> from Tamil Nadu and this is a task Conducted by <b>9eye for intenship hiring.</b></h3>
              <p>Thanking you to Spending time with my work (Online Bar) </p>
            </form>
          </section>
